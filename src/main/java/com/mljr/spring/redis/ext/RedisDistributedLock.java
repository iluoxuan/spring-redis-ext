...
public class RedisDistributedLock {
    ...
    // 线程变量
    private final static ThreadLocal<Holder> LOCAL = new ThreadLocal<Holder>();

    /**
     * 锁的过期时间(解决死锁)，单位：毫秒
     */
    private static long lock_timeout = 3 * 1000;

    /**
     * 尝试获取锁的间隔时间
     */
    private static long retry_lock_time = 500;
    ...
    private static int ADD_MILLI_MASK = 1023;
    ...
    public boolean tryLock(String lockName) {
        ...
        lockName = "fenqi_cluster_lock_" + lockName;
